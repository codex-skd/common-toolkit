...
import com.skd.commontoolkit.menu.QuickMoveHandler.QuickMoveMenu;
 ...
 */
public abstract class CommonToolkitContainerMenu extends AbstractContainerMenu implements QuickMoveMenu {
    ...
    protected CommonToolkitContainerMenu(MenuType<?> type, int id, Inventory pInv) {
        super(type, id);
    ...
    protected class UpdatingSlot extends FilteredSlot {
        ...
        public void setChanged() {
            super.setChanged();
            CommonToolkitContainerMenu.this.slotsChanged(null);
        }
    }
