...
package com.skd.commontoolkit.config;

import static com.skd.commontoolkit.config.Property.Type.BOOLEAN;
import static com.skd.commontoolkit.config.Property.Type.DOUBLE;
import static com.skd.commontoolkit.config.Property.Type.INTEGER;
import static com.skd.commontoolkit.config.Property.Type.STRING;
...
public class Configuration {
    private static final Logger LOGGER = LoggerFactory.getLogger("CommonToolkit - Configuration");
    ...
    public Configuration(File file) {
        ...
        try {
            ...
            CommonToolkit.LOGGER.error("An exception occurred while loading config file {}. This file will be renamed to {} " + "and a new config file will be generated.", file.getName(), fileBak.getName(), e);
